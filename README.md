...
Podczas mojej podnad cwierćwiecznej pracy z technologiami :IBM-bw: czasami wymyślę coś czego nie chę wymyślać drugi raz. Wtedy wrzucam to tutaj. Kiedyś ten projekt leżał wyłąćznie na GitHubie, ale postanowiłem go "ukompatybilnić" z `mkdocs`, stąd umiezczenie wszystkiedo w podkatalogu `docs`. 
