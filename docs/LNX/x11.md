...
!!! Warning "Uwaga:"
	Zakładam, że klientem ssh, dysponującym graficznym środwoskiem jest jakiś Linux, albo Mac ( choć :fontawesome-brands-apple: nie sprawdzałem). Jak działasz pod WinDOS, to pewnie potrzebujesz jakiegoś X-servera, np X-ming. A może lepiej przejść na WSL?
